...
<nav class="navbar navbar-inverse navbar-expand-lg" role="navigation">
  ...
  <ul class="nav navbar-nav mr-auto">
			...
			<li><a href="/StudentInfo/StudentHandler/queryvitastu?sid=${sessionScope.sid }"><strong>管理个人信息</strong></a>
    </ul>
	<p class="navbar-text navbar-right">你好！${sessionScope.sname} &nbsp;同学<a href="/StudentInfo/LoginHandler/studentlogout" class="navbar-link" href="#">注销</a></p>
	<!--
    <ul class="nav navbar-nav mr-auto">
